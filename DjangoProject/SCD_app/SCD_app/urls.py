...
# plug
    #path('plugs/create/', views.PlugCreateView.as_view(), name='create_plug'),
...
# thermostat
    #path('thermostat/create/', views.ThermostatCreateView.as_view(), name='create_plug'),
...
# curtain
    #path('curtains/create/', views.CurtainCreateView.as_view(), name='create_plug'),
...
# weather station
    #path('weather_stations/create/', views.WeatherStationCreateView.as_view(), name='create_plug'),
...
# lawn mower
    #path('lawn_mowers/create/', views.LawnMowerCreateView.as_view(), name='create_plug'),
